    ...
    return (
      <div className="mainContainer">
        ...
        <div className="content">
          ...
          <Route path={`${this.props.match.url}/teachers`} render={() => (<Teachers />)} />
          <Route path={`${this.props.match.url}/status`} render={() => (<Status />)} />
          <Route path={`${this.props.match.url}/news/:idx`} component={News} />
          <Route path={`${this.props.match.url}/config/teachers`} component={configTeachers} />
          <Route path={`${this.props.match.url}/config/status`} component={configStatus} />
        </div>
        <BottomNavigation
          value={value}
